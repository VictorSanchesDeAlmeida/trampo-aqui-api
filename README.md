...
|------|----| --------- | ---------- |
| **Admin** | 1 | Administrador | Gerencia sistema, deleta cursos |
| **User** | 2 | Usuário comum | Pode criar empresa |
...
3. **Autorização**: Guards verificam role necessária
4. **Endpoints públicos**: Marcados com `@Public()`
